...
const FolderItem = ({ folder, onOpenFolder, onRenameFolder, index, onSelect, isLargeIcon, onDropFile  } :
  { 
    folder: Folder,
  ...
  return (
    <div ref={divRef} className={`flex flex-1 ${isLargeIcon ? 'flex-col max-w-44' : 'flex-row'} items-center gap-1 p-1 cursor-default folder-item select-none
      ...
      ${isDragOver ? '!bg-amber-200/10' : isSelected ? '!bg-blue-500/40' : ''} 
    ...
    >
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={isLargeIcon ? '64px' : '40px'} height={isLargeIcon ? '64px' : '40px'} viewBox="0 0 32 32">
